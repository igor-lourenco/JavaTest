...
import com.frete.services.EnderecamentoService;
import com.frete.services.FreteService;

import io.restassured.http.ContentType;

@WebMvcTest
public class FreteResourceTests {
	
	@Autowired
	private FreteResource freteResource;
	...
	private final String PATH = "http://localhost:8080/frete";
	
	@BeforeEach
	public void setUp() {
		standaloneSetup(this.freteResource);
	}
