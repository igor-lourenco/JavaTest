...
import static com.frete.utils.EnderecamentoUtils.criarFakeEnderecamentoDTOBlumenau;
import static com.frete.utils.EnderecamentoUtils.criarFakeEnderecamentoDTOFlorianopolis;
import static com.frete.utils.EnderecamentoUtils.criarFakeEnderecamentoDTOSP;
import static com.frete.utils.FreteUtils.criarFakeFreteInputDTO;
import static com.frete.utils.FreteUtils.criarFakeFreteModel;
import static com.frete.utils.FreteUtils.criarFakeFreteOutputDTO;
...
public class FreteServiceTests {
	...
	void findById_ThrowsObjectNotFoundException_QuandoFreteNaoEncontrado() {
		...
		assertThrows(ResourceNotFoundException.class, () -> freteService.findById(1L));
	}
